...
#import logging
#import sys
from brainspy.utils.waveform import generate_waveform
from brainspy.platforms.chooser import get_platform
from .core.fitness import choose_fitness_function
from .core.classifier import perceptron
from .core.observer import GAObserver
...
# %% Method implementing evolution
    def optimize(self, inputs, targets,
        ...
        for gen in range(self.generations):
            ...
            self.outputs = self.platform.evaluate_population(self.inputs_wfm,
                                                             self.pool,
                                                             self.target_wfm)
...
#%% #################################################
    ...
    def waveform(self, data):
        data_wfrm = generate_waveform(data, self.lengths, slopes=self.slopes)
